...
public class ExpertListAdapterPresenterImpl implements IExpertListAdapterPresenter{
    IExpertListAdapterView iExpertListAdapterView;
    public ExpertListAdapterPresenterImpl(IExpertListAdapterView iExpertListAdapterView){
        this.iExpertListAdapterView = iExpertListAdapterView;
    }
...
//                            iExpertListAdapterView.showExpertInfo(user, questions);
                        }catch (JSONException e){
//                            Log.d("JSONException：", e.getMessage());
//                            iExpertListAdapterView.showMessage("JSONException：" + e.getMessage());
                        }
                    }
                    @Override
